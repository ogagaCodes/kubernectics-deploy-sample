...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSingleUser = channel.unary_unary(
                ...
                request_serializer=user__pb2.GetSingleUserRequest.SerializeToString,
                response_deserializer=user__pb2.GetSingleUserResponse.FromString,
                )
        self.GetAllUsers = channel.unary_unary(
                '/UserService/GetAllUsers',
                request_serializer=user__pb2.InputEmpty.SerializeToString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetSingleUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=user__pb2.GetSingleUserRequest.FromString,
                    response_serializer=user__pb2.GetSingleUserResponse.SerializeToString,
            ),
            'GetAllUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.GetAllUsers,
                    request_deserializer=user__pb2.InputEmpty.FromString,
...
class UserService(object):
    ...
    def CreateAdmin(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserService/CreateAdmin',
    ...
    def GetSingleUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserService/GetSingleUser',
            user__pb2.GetSingleUserRequest.SerializeToString,
            user__pb2.GetSingleUserResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetAllUsers(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/UserService/GetAllUsers',
            user__pb2.InputEmpty.SerializeToString,
